...
func main() {
	...
	//golog.Info(edgerc_temp[2][(strings.Index(edgerc_temp[2], "=") + 2):])
	AkamaiHost = AkamaiHost + edgerc_temp[2][(strings.Index(edgerc_temp[2], "=")+2):]
...
func Send(method, url string, data []byte) []byte {
	...
	accessToken := edgerc_temp[3][(strings.Index(edgerc_temp[3], "=") + 2):]
	//golog.Info(edgerc_temp[3][(strings.Index(edgerc_temp[3], "="))+2:])
	clientToken := edgerc_temp[4][(strings.Index(edgerc_temp[4], "=") + 2):]
	//golog.Info(edgerc_temp[4][(strings.Index(edgerc_temp[4], "="))+2:])
	clientSecret := edgerc_temp[1][(strings.Index(edgerc_temp[1], "=") + 2):]
	//golog.Info(edgerc_temp[1][(strings.Index(edgerc_temp[1], "="))+2:])
	...
	if resp.StatusCode > 201 {
		golog.Fatal("Response code is not OK!" + resp.Status)
	}
	return contents
}
